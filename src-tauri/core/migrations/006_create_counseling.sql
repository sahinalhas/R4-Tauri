...
-- Create counseling session students junction table
...
-- Create family participation table
...
-- Create counseling reminders table
...
-- Create counseling follow ups table
...
-- Create counseling outcomes table
